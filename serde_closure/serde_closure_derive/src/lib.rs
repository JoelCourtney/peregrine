...
use syn::{
    ...
    Arm, AttributeArgs, Block, Error, Expr, ExprArray, ExprAssign, ExprAssignOp, ExprAsync,
    ExprAwait, ExprBinary, ExprBlock, ExprBox, ExprBreak, ExprCall, ExprCast, ExprClosure,
    ExprField, ExprForLoop, ExprGroup, ExprIf, ExprIndex, ExprLet, ExprLoop, ExprMacro, ExprMatch,
    ...
    ExprYield, FieldValue, GenericParam, Ident, ImplItem, Item, ItemImpl, Lifetime, LifetimeDef,
    Local, Member, Pat, PatBox, PatIdent, PatReference, PatSlice, PatTuple, PatTupleStruct,
    PatType, Path, PathArguments, PathSegment, ReturnType, Stmt, TraitBound, Type, TypeInfer,
    TypeReference, TypeTuple, UnOp,
};
...
fn bijective_base_test() {
    ...
    assert_eq!(
        bijective_base(u64::MAX, 3, alpha_upper),
        "AAAABBABCBBABBAABCCAACCCACAACACCACCBAABBA"
    );
    assert_eq!(
        bijective_base(u64::MAX, 2, alpha_upper),
